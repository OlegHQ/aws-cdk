 ...
 * @deprecated Use `OpenIdConnectProviderNative` instead. To migrate existing resources:
 ...
 * 4. Run `cdk import` to import the existing OIDC provider resource by providing the existing ARN.
